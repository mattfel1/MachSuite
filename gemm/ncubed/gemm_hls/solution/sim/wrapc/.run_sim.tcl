...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "gemm.autotvin.dat"
	set constFileTvOut       "gemm.autotvout.dat"
	set constFileHdlTvIn     "gemm.autohdltvin.dat"
	set constFileHdlTvOut    "gemm.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
