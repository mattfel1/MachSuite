#pragma line 1 "/local/ssd/home/mattfel/machsuite/gemm/ncubed/local_support.c"
#pragma line 1 "<built-in>"
#pragma line 1 "<command-line>"
#pragma line 1 "/local/ssd/home/mattfel/machsuite/gemm/ncubed/local_support.c"
#pragma line 1 "/local/ssd/home/mattfel/machsuite/gemm/ncubed/gemm.h" 1
#pragma empty_line
...
#pragma empty_line
#pragma line 3 "/local/ssd/home/mattfel/machsuite/gemm/ncubed/gemm.h" 2
...
#pragma empty_line
#pragma line 4 "/local/ssd/home/mattfel/machsuite/gemm/ncubed/gemm.h" 2
#pragma line 1 "/local/ssd/home/mattfel/machsuite/gemm/ncubed/support.h" 1
#pragma empty_line
...
#pragma empty_line
#pragma line 3 "/local/ssd/home/mattfel/machsuite/gemm/ncubed/support.h" 2
#pragma empty_line
#pragma empty_line
...
#pragma line 76 "/local/ssd/home/mattfel/machsuite/gemm/ncubed/support.h"
struct prng_rand_t {
  uint64_t s[((1)<<6)];
  uint_fast16_t i;
  uint_fast16_t c;
...
#pragma line 5 "/local/ssd/home/mattfel/machsuite/gemm/ncubed/gemm.h" 2
#pragma line 21 "/local/ssd/home/mattfel/machsuite/gemm/ncubed/gemm.h"
...
#pragma line 2 "/local/ssd/home/mattfel/machsuite/gemm/ncubed/local_support.c" 2
...
#pragma empty_line
#pragma line 3 "/local/ssd/home/mattfel/machsuite/gemm/ncubed/local_support.c" 2
#pragma empty_line
...
#pragma line 20 "/local/ssd/home/mattfel/machsuite/gemm/ncubed/local_support.c"
void input_to_data(int fd, void *vdata) {
...
#pragma empty_line
  ...
  parse_double_array(s, data->m1, 64*64);
#pragma empty_line
  s = find_section_start(p,2);
  parse_double_array(s, data->m2, 64*64);
  free(p);
#pragma empty_line
}
#pragma empty_line
...
#pragma empty_line
  ...
  write_double_array(fd, data->m1, 64*64);
#pragma empty_line
  write_section_header(fd);
  write_double_array(fd, data->m2, 64*64);
}
#pragma empty_line
#pragma empty_line
#pragma empty_line
...
#pragma empty_line
  s = find_section_start(p,1);
  parse_double_array(s, data->prod, 64*64);
  free(p);
}
#pragma empty_line
void data_to_output(int fd, void *vdata) {
...
#pragma empty_line
  write_section_header(fd);
  write_double_array(fd, data->prod, 64*64);
}
#pragma empty_line
int check_data( void *vdata, void *vref ) {
  struct bench_args_t *data = (struct bench_args_t *)vdata;
...
#pragma empty_line
  for( r=0; r<64; r++ ) {
    for( c=0; c<64; c++ ) {
      diff = data->prod[r*64 + c] - ref->prod[r*64 +c];
      has_errors |= (diff<-((double)1.0e-6)) || (((double)1.0e-6)<diff);
    }
  }
#pragma empty_line
#pragma empty_line
