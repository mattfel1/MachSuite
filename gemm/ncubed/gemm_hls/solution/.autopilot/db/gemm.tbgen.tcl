set C_TypeInfoList {{ 
"gemm" : [[], { "return": [[], "void"]} , [{"ExternC" : 0}], [ {"m1": [[], {"array": [ {"scalar": "double"}, [4096]]}] }, {"m2": [[], {"array": [ {"scalar": "double"}, [4096]]}] }, {"prod": [[], {"array": [ {"scalar": "double"}, [4096]]}] }],[],""]
}}
set moduleName gemm
...
set C_modelArgList {
	{ m1 double 64 regular {array 4096 { 1 1 } 1 1 }  }
	{ m2 double 64 regular {array 4096 { 1 1 } 1 1 }  }
	{ prod double 64 regular {array 4096 { 0 3 } 0 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "m1", "interface" : "memory", "bitwidth" : 64, "direction" : "READONLY", "bitSlice":[{"low":0,"up":63,"cElement": [{"cName": "m1","cData": "double","bit_use": { "low": 0,"up": 63},"cArray": [{"low" : 0,"up" : 4095,"step" : 1}]}]}]} , 
 	{ "Name" : "m2", "interface" : "memory", "bitwidth" : 64, "direction" : "READONLY", "bitSlice":[{"low":0,"up":63,"cElement": [{"cName": "m2","cData": "double","bit_use": { "low": 0,"up": 63},"cArray": [{"low" : 0,"up" : 4095,"step" : 1}]}]}]} , 
 	{ "Name" : "prod", "interface" : "memory", "bitwidth" : 64, "direction" : "WRITEONLY", "bitSlice":[{"low":0,"up":63,"cElement": [{"cName": "prod","cData": "double","bit_use": { "low": 0,"up": 63},"cArray": [{"low" : 0,"up" : 4095,"step" : 1}]}]}]} ]}
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.gemm_dadd_64ns_64bkb_U1", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.gemm_dadd_64ns_64bkb_U2", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.gemm_dmul_64ns_64cud_U3", "Parent" : "0"},
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.gemm_dmul_64ns_64cud_U4", "Parent" : "0"}]}
...
set ArgLastReadFirstWriteLatency {
	gemm {
		...
		prod {Type O LastRead -1 FirstWrite 267}}}

set hasDtUnsupportedChannel 0

set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "131308", "Max" : "131308"}
	, {"Name" : "Interval", "Min" : "131309", "Max" : "131309"}
]}
...
set Spec2ImplPortList { 
	m1 { ap_memory {  { m1_address0 mem_address 1 12 }  { m1_ce0 mem_ce 1 1 }  { m1_q0 mem_dout 0 64 }  { m1_address1 mem_address 1 12 }  { m1_ce1 mem_ce 1 1 }  { m1_q1 mem_dout 0 64 } } }
	m2 { ap_memory {  { m2_address0 mem_address 1 12 }  { m2_ce0 mem_ce 1 1 }  { m2_q0 mem_dout 0 64 }  { m2_address1 mem_address 1 12 }  { m2_ce1 mem_ce 1 1 }  { m2_q1 mem_dout 0 64 } } }
